import css from "./_addProductForm.module.scss";
...
import { addProduct } from "../model/addAsyncThunk";
...
import CalcExpirationDate from "../lib/calcExpirationDate";
import getBarcodesInfo from "../lib/getBarcodesInfo";
import findSimilarProduct from "../lib/findSimilarProduct";
...
import Similar from "@/pages/add-product/components/similar/similar";
            ...
            <div className={css.formInput}>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  findSimilarProduct(products, e.target.value, setSimilarItems);
                }}
              />

              <div
                className={
                  similarItems.length ? css.similar_active : css.similar
                }
